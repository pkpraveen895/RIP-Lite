...
class QuaggaTopo(Topo):
    ...
    def __init__(self):
        ...
        quaggaHosts.append( QuaggaHost( name='R3', ip ='172.0.5.2/24', loIP = None ) )
        ...
        for host in quaggaHosts:
            ...
            quagga_hosts.append( self.addHost(name=host.name,ip=host.ip,hostname=host.name,privateLogDir=True,privateRunDir=True,inMountNamespace=True,inPIDNamespace=True,inUTSNamespace=True))
